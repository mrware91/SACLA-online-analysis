...
###############################################################################################
    ...
    def filt_data(self):
        ...
        print('nan filter mask')
        print(nan_filter_mask)
    ...
    def plot_histogram(self):
        ...
        print('filt size, max; plot max')
        print(self.filt_x.size)
        print(np.max(self.filt_x))
        print(np.max(self.plot_x))
...
###############################################################################################
    ...
    def update_plot_instance(self):
        ...
        if self.plot_y is None:
                ...
                print('plot x size, max')
                print(self.plot_x.size)
                print(self.plot_x.max())
                try:
                        if self.refresh_plot:
                                if self.radioBtn_scatter.isChecked():
                                        self.plot_scatter()
